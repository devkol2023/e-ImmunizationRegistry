  ...
  tableData = [
    {
      ...
      email: 'healthworker@eimmunization.com',
      roleDesc: 'Responsible for administering vaccinations, monitoring patient reactions, and maintaining vaccination records.',
      toggle: true,
    },
    {
      roleName: 'Doctor',
      email: 'doctor@eimmunization.com',
      roleDesc: 'Provides medical oversight, conducts patient consultations, and ensures adherence to health protocols.',
      toggle: true,
    },
    {
      roleName: 'Nurse',
      email: 'nurse@eimmunization.com',
      roleDesc: 'Assists with patient preparation, administers vaccinations, and provides post-vaccination care.',
      toggle: true,
    },
